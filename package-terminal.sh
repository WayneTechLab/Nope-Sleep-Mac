...
cp "$SCRIPT_DIR/resources/uninstall-helper.sh" "$PACKAGE_DIR/uninstall.sh"
cp "$SCRIPT_DIR/README.md" "$PACKAGE_DIR/README.md"
cp "$SCRIPT_DIR/DISCLAIMER.md" "$PACKAGE_DIR/DISCLAIMER.md"
touch "$PACKAGE_DIR/.nsm-install-package"
...
echo "Full cleanup after install:"
echo "  \"$PACKAGE_DIR_NAME/uninstall.sh\""
